...
### Nova Platform Technical Constraints
...
| Knowledge structure, concept relationships, prerequisite mapping | `knowledge-graph` | `graphSubject`, `graphLayout` |
