/**
 * @nova/storage — the Nova pluggable persistence layer.
 *
 * Dependency arrow (kept acyclic): `@nova/storage -> @nova/dsl` only.
...
export type { AssetRef, AssetMeta, BinaryBlob, StorageProvider } from '@nova/dsl';
