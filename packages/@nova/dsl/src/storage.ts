 ...
 * document to another runtime. `@nova/renderer` already consumes resolved
 * URLs via its media slots; `@nova/exporter` will consume the set of refs a
 ...
 * live in `@nova/storage`, keeping this package dependency- and DOM-free.
 */
 ...
 * pure package to the DOM lib. Backends in `@nova/storage` accept a real
