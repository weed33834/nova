/**
 * The Nova slide object model — the canonical, dependency-free contract.
 *
 * This file is the single source of truth that supersedes the three copies that
 * had drifted apart before @nova/dsl existed:
 *   - app:      lib/types/slides.ts
 *   - renderer: packages/@nova/renderer/src/types/slides.ts
 *   - importer: packages/@nova/importer/src/nova/types/slides.ts
 *
