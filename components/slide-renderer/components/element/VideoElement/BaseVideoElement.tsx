...
import type { PPTVideoElement } from '@nova/dsl';
    ...
    >
      ...
      >
        {showDisabled ? (
          ...
          <div className="w-full h-full bg-gradient-to-br from-indigo-50 via-pink-50/60 to-blue-50 dark:from-indigo-950/40 dark:via-pink-950/30 dark:to-blue-950/20 flex items-center justify-center rounded">
            <style>{`
