...
import type { Slide, PPTElement, PPTVideoElement } from '@nova/dsl';
...
import { SlideCanvas } from '@nova/renderer';
 ...
 *
 * `@nova/renderer` is a pure package: it renders `element.src` as-is and knows
...
/**
 * Read-only thumbnail rendering for a video element. Replaces `@nova/renderer`'s
...
/**
 * Read-only slide thumbnail rendered via the extracted `@nova/renderer`
 ...
 * is intentionally untouched (`@nova/renderer` v1 is read-only; editing is v2).
 */
