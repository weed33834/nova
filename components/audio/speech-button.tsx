      ...
      <TooltipTrigger asChild>
        <button
          ...
          className={cn(
            ...
            sizeClasses,
            active
              ? 'bg-pink-500/90 dark:bg-pink-600/80 text-white shadow-[0_0_12px_rgba(219, 39, 119,0.45)] dark:shadow-[0_0_12px_rgba(219, 39, 119,0.3)]'
        ...
        >
          ...
          {isRecording && (
            <span
              className="absolute inset-[-4px] rounded-[10px] border border-pink-400/40 dark:border-pink-400/25"
              style={{
