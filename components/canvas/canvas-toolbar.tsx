        ...
        >
                ...
                <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg px-2 py-2.5 flex flex-col items-center gap-1.5">
                  ...
                  <input
                    ...
                    className={cn(
                      ...
                      '[&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-pink-500 [&::-webkit-slider-thumb]:dark:bg-pink-400',
                ...
                <TooltipTrigger asChild>
                  <button
                    ...
                    className={cn(
                      ...
                      'active:scale-90',
                      playbackSpeed !== 1
                        ? 'text-pink-600 dark:text-pink-400 bg-pink-500/10 dark:bg-pink-400/10'
          ...
          >
            ...
            {!whiteboardOpen && whiteboardElementCount > 0 && (
              <span className="absolute top-0.5 right-0.5 w-1.5 h-1.5 bg-pink-500 dark:bg-pink-400 rounded-full" />
            )}
          </button>
        </div>
      </div>
