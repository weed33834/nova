                ...
                {isGenerationFailed ? (
                  ...
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="relative w-12 h-12">
                      ...
                      <div className="absolute inset-0 rounded-full border-2 border-transparent border-t-pink-500 dark:border-t-pink-400 animate-spin" />
                    </div>
                    {/* Text */}
                    <motion.span
            ...
            {showPlayHint && (
              ...
              >
                ...
                >
                  ...
                  >
                    <Play className="w-7 h-7 text-pink-600 dark:text-pink-400 fill-pink-600/90 dark:fill-pink-400/90 ml-0.5" />
                  </motion.div>
                </motion.div>
              </motion.div>
            )}
