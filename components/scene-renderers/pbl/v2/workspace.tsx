...
function WorkspaceTopBar({
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_20%_0%,rgba(244,114,182,0.20),transparent_30%),radial-gradient(circle_at_78%_0%,rgba(245,158,11,0.13),transparent_26%),linear-gradient(90deg,rgba(255,255,255,0.05),transparent_34%,rgba(255,255,255,0.035))]" />
      <div className="relative flex min-w-0 flex-1 items-center gap-3">
        <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-pink-200/25 bg-pink-100/[0.08] shadow-[0_0_24px_rgba(244,114,182,0.18)]">
          <Image src="/nova-mark.png" alt="Nova" width={28} height={28} className="h-6 w-6" />
        </div>
        <div className="min-w-0">
          ...
          >
            <button
              ...
              className="rounded bg-gradient-to-r from-pink-200 via-cyan-200 to-sky-200 bg-clip-text text-transparent transition-opacity hover:opacity-80 focus-visible:underline focus-visible:outline-none"
            >
      ...
      <div className="relative col-start-3 hidden min-w-0 items-center gap-2 lg:flex">
        <div className="flex h-8 shrink-0 items-center gap-1.5 rounded-full border border-indigo-100/[0.14] bg-white/[0.045] px-2.5 text-[11px] font-medium text-indigo-100/82">
          <Workflow className="h-3.5 w-3.5 text-pink-200/90" />
              ...
              >
                <div
                  className={cn(
                    ...
                    active && 'bg-pink-300 shadow-[0_0_16px_rgba(244, 114, 182,0.42)]',
                    !active && !completed && 'bg-slate-500/35',
                  )}
                />
                {active && (
                  <div
                    className="absolute top-1/2 h-4 w-4 -translate-x-1/2 -translate-y-1/2 rounded-full border border-white/50 bg-pink-300 shadow-[0_0_18px_rgba(244, 114, 182,0.58)] transition-[left] duration-500 ease-out"
