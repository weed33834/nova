 ...
 * Nova uses for AI-element messages) so Instructor replies,
  ...
  return (
    <div
      className={cn(
        ...
        'prose-code:px-1 prose-code:py-0.5 prose-code:rounded prose-code:bg-white/10 prose-code:text-pink-100',
