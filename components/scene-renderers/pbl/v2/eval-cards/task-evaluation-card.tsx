  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-2">
        <span className="inline-flex items-center gap-1.5 text-[10px] font-semibold uppercase tracking-wider text-pink-700">
          <ClipboardCheck className="h-3 w-3" />
          {t('pbl.v2.taskEvalCard.title')}
        </span>
        {score !== undefined && (
          <span
            className="rounded-md border border-pink-200/70 bg-pink-100/90 px-1.5 py-0.5 font-mono text-[11px] font-semibold text-pink-700 shadow-sm"
