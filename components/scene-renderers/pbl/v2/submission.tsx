 ...
 *   persisted to IndexedDB by the Nova stage layer. The Modal's
...
function SubmissionModal({
  ...
  const handleFile = async (file: File) => {
    ...
    abortRef.current = ac;
    // Image / screenshot: store via Nova's existing object storage
    ...
    // PDF: parse to text via Nova's existing /api/parse-pdf (reused, not
