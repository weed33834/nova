...
> = {
  ...
  quiz: {
    chip: 'bg-pink-50 text-pink-600 dark:bg-pink-500/10 dark:text-pink-300',
    chipHover: 'hover:bg-pink-100/80 dark:hover:bg-pink-500/15',
    accent: 'bg-pink-500',
    dot: 'bg-pink-400',
  },
  interactive: {
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    'border',
                    selected
                      ? 'border-pink-500/40 bg-pink-500/10 text-pink-700 dark:text-pink-200'
