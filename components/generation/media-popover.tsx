      ...
      <PopoverTrigger asChild>
        <button
          className={cn(
            ...
            enabledCount > 0
              ? 'bg-pink-100 dark:bg-pink-900/30 text-pink-700 dark:text-pink-300 border-pink-200/60 dark:border-pink-700/50'
            ...
            {TABS.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  {isEnabled && !isActive && (
                    <span className="absolute top-1 right-1 size-1.5 rounded-full bg-pink-500" />
                  )}
                </button>
              );
            })}
      ...
      <div className="flex items-center gap-2.5">
        <Icon
          className={cn(
            ...
            enabled ? 'text-pink-600 dark:text-pink-400' : 'text-muted-foreground/50',
          )}
        />
        <span
          className={cn(
