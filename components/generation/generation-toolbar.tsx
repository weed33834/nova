...
export function GenerationToolbar({
  ...
  const pillActive = `${pillCls} border-pink-200/60 dark:border-pink-700/50 bg-pink-100 dark:bg-pink-900/30 text-pink-700 dark:text-pink-300`;
        ...
        <Popover>
          <PopoverTrigger asChild>
            {courseMaterials.length > 0 ? (
              ...
              <button className={pillMuted} data-tour="course-materials">
                <Paperclip className="size-3.5" />
              </button>
            )}
          </PopoverTrigger>
                ...
                <div
                  className={cn(
                    ...
                    isDragging
                      ...
                      : 'border-muted-foreground/20 hover:border-pink-300',
                  )}
            ...
            <PopoverContent align="start" className="w-64 p-3 space-y-3">
              ...
              >
                <Globe2
                  className={cn(
                    'size-4 shrink-0',
                    webSearch ? 'text-pink-600 dark:text-pink-400' : 'text-muted-foreground',
                  )}
                />
...
function InlineThinkingControl({
  ...
  const selectTriggerCls =
    'h-6 min-w-[84px] rounded-full border-0 bg-pink-100 px-2 py-0 !text-[10px] font-medium leading-none text-pink-700 shadow-none focus-visible:ring-0 data-[size=sm]:h-6 dark:bg-pink-900/40 dark:text-pink-200 [&_svg]:size-3';
  ...
  return (
    ...
    >
      <Brain className="size-3.5 shrink-0 text-pink-500" />
      <div className="flex min-w-0 items-center gap-0.5 rounded-full border border-pink-200/70 bg-white/65 p-0.5 dark:border-pink-800/70 dark:bg-pink-950/25">
        {hasAutoBudget && (
          <Select
          ...
          >
            <SelectTrigger
              size="sm"
              className="h-6 min-w-[76px] rounded-full border-0 bg-pink-100 px-2 py-0 !text-[10px] font-medium leading-none text-pink-700 shadow-none focus-visible:ring-0 data-[size=sm]:h-6 dark:bg-pink-900/40 dark:text-pink-200 [&_svg]:size-3"
            >
              <SelectValue />
            </SelectTrigger>
        ...
        {(thinking.control === 'toggle-budget' || thinking.control === 'budget-only') &&
          ...
          (!hasAutoBudget || autoBudgetMode === 'enabled') && (
            <label className="ml-0.5 grid h-6 shrink-0 grid-cols-[auto_60px] items-stretch overflow-hidden rounded-full border border-pink-200/70 bg-background dark:border-pink-800/70">
              <span className="grid h-[22px] shrink-0 place-items-center border-r border-pink-200/70 bg-muted/30 px-2 font-sans text-[11px] font-medium leading-[22px] text-muted-foreground dark:border-pink-800/70">
          ...
          <PopoverTrigger asChild>
            <button
              ...
              className={cn(
                ...
                'border-pink-200/70 bg-pink-50 text-pink-700 hover:bg-pink-100 dark:border-pink-800/70 dark:bg-pink-950/30 dark:text-pink-300',
                currentModelId &&
                  'shadow-[0_0_0_1px_rgba(124,58,237,0.12)] dark:shadow-[0_0_0_1px_rgba(244, 114, 182,0.16)]',
              )}
            >
              {currentProviderIcon ? (
                <img
              ...
              {currentThinkingLabel && (
                <span className="shrink-0 rounded-full bg-white/80 px-1.5 py-0.5 text-[10px] font-semibold leading-none text-pink-700 ring-1 ring-pink-200/70 dark:bg-pink-950/50 dark:text-pink-200 dark:ring-pink-800/70">
                  {currentThinkingLabel}
                </span>
              )}
            </button>
                ...
                providerEntries.map(({ provider, matchingModels }) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isCurrent && <span className="size-1.5 rounded-full bg-pink-500" />}
                    </button>
                  );
                })
              )}
                  ...
                  return (
                    <div
                      ...
                      className={cn(
                        ...
                        isSelected
                          ? 'bg-pink-50 text-pink-700 ring-1 ring-pink-200 dark:bg-pink-950/25 dark:text-pink-300 dark:ring-pink-800'
                          : 'hover:bg-muted/60',
                      )}
                    >
                      <div className="min-w-0 flex-1">
                      ...
                      {isSelected && (
                        <Check className="size-3.5 shrink-0 text-pink-600 dark:text-pink-400" />
                      )}
                    </div>
                  );
                })
