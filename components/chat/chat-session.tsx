      ...
      <div className="flex gap-1.5 items-center py-1.5 px-1">
        <span
          className={cn(
            ...
            isTeacher
              ? 'bg-pink-400/70 dark:bg-pink-500/70'
  ...
  return (
    <div
      className={cn(
        ...
        isUser
          ? 'bg-gradient-to-br from-pink-600 to-pink-700 dark:from-pink-500 dark:to-pink-600 text-white rounded-tr-sm shadow-sm shadow-pink-300/30 dark:shadow-pink-900/50 ring-1 ring-pink-500/20'
          : isTeacher
          ...
          return (
            <motion.div
              ...
              className={cn(
                ...
                isActiveBubble &&
                  'border-l-pink-500 dark:border-l-pink-400 bg-pink-50/50 dark:bg-pink-900/20',
              )}
            >
              {/* Mini Avatar */}
