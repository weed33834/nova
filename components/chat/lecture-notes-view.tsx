  ...
  if (notes.length === 0) {
    return (
      <div className="h-full flex flex-col items-center justify-center text-center p-6">
        <div className="w-12 h-12 bg-pink-50 dark:bg-pink-900/20 rounded-2xl flex items-center justify-center mb-3 text-pink-300 dark:text-pink-600 ring-1 ring-pink-100 dark:ring-pink-800/30">
        ...
        return (
          <div
            ...
            className={cn(
              ...
              isCurrent
                ? 'bg-pink-50/80 dark:bg-pink-950/25 ring-1 ring-pink-200/60 dark:ring-pink-700/30'
            ...
            <div className="flex items-center gap-2 mb-1.5">
              ...
              <div
                className={cn(
                  ...
                  isCurrent
                    ? 'bg-pink-500 dark:bg-pink-400 shadow-sm shadow-pink-400/40'
              ...
              {isCurrent && (
                <span className="text-[9px] font-bold px-1.5 py-px rounded-full bg-pink-100 dark:bg-pink-900/40 text-pink-600 dark:text-pink-300">
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          isActiveSpeech
                            ? 'bg-pink-100/80 text-pink-800 dark:bg-pink-900/35 dark:text-pink-200'
