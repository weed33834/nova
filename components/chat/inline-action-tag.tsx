...
const WB_STYLE =
  'bg-pink-50 dark:bg-pink-500/15 border-pink-300/40 dark:border-pink-500/30 text-pink-600 dark:text-pink-300';
const WB_ACCENT = 'bg-pink-500 dark:bg-pink-400';
  ...
  return (
    ...
    >
      ...
      {isWb && (
        ...
        >
          <PenLine className="w-[7px] h-[7px] text-white dark:text-pink-950" strokeWidth={2.5} />
        </span>
      )}
