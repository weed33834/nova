    ...
    return (
      ...
      >
        ...
        {!collapsed && (
          ...
          >
            <div className="absolute left-0.5 top-1/2 -translate-y-1/2 w-0.5 h-8 rounded-full bg-gray-300 dark:bg-gray-600 group-hover:bg-pink-400 dark:group-hover:bg-pink-500 transition-colors" />
          </div>
        )}
