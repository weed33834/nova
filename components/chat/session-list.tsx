...
const sessionBadgeStyles = {
  ...
  lecture: 'bg-pink-100 text-pink-700 dark:bg-pink-900/30 dark:text-pink-300',
};
        ...
        return (
          <div
            ...
            className={cn(
              ...
              isActive
                ? 'border-pink-200 dark:border-pink-700 bg-pink-50/30 dark:bg-pink-900/20 shadow-sm'
