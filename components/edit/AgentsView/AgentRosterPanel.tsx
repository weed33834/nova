  ...
  return (
    <span
      ...
      className={cn(
        ...
        'focus:shadow-[0_0_0_2px_rgba(219, 39, 119,.18)]',
        className,
      )}
      style={{ minWidth: 10 }}
    >
      ...
      <div className="flex flex-1 min-h-0 flex-col overflow-y-auto px-3 pb-4">
        ...
        <button
          ...
          onMouseEnter={(e) => {
            ...
            (e.currentTarget as HTMLButtonElement).style.color = '#DB2777';
