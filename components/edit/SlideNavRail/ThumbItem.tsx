  ...
  return (
    ...
    >
      <div
        ...
        // tile flipped to pink-50 + ring when active. Differences from
        ...
        className={cn(
          ...
          active
            ? 'bg-pink-50 ring-1 ring-pink-200 dark:bg-pink-900/20 dark:ring-pink-700'
          ...
          <div className="flex min-w-0 items-center gap-2">
            <span
              className={cn(
                ...
                active
                  ? 'bg-pink-600 text-white shadow-sm shadow-pink-500/30 dark:bg-pink-500'
            ...
            {renaming ? (
              <input
                ...
                className={cn(
                  ...
                  'ring-1 ring-pink-400 focus:ring-pink-500',
                  'text-zinc-800 dark:bg-zinc-900 dark:text-zinc-100 dark:ring-pink-500',
                )}
              />
            ) : (
              <span
