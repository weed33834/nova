    ...
    >
      ...
      {!collapsed && (
        <div
          ...
          className="group absolute right-0 top-0 bottom-0 w-1.5 cursor-col-resize touch-none hover:bg-pink-400/30 dark:hover:bg-pink-500/30 active:bg-pink-500/50 transition-colors"
        >
      ...
      {/* Header band — mirrors playback `SceneSidebar`: Nova logo
