  ...
  return (
    <div ref={rootRef} className="absolute inset-0 z-[120]">
      ...
      {outlines.map((o) => (
        <div
          key={o.id}
          className="pointer-events-none absolute rounded-[3px] ring-1 ring-pink-400/40 bg-pink-400/[0.04]"
      ...
      {hover && hover.box.width > 0 && (
        <div
          className="pointer-events-none absolute rounded-md ring-2 ring-pink-500 bg-pink-500/[0.06]"
          style={{
      ...
      {/* instruction banner */}
      <div className="pointer-events-none absolute left-1/2 top-3 -translate-x-1/2 rounded-full border border-pink-300/60 bg-popover/95 px-3.5 py-1.5 text-[12px] font-medium text-foreground shadow-lg shadow-black/10 backdrop-blur">
