...
const TYPE_ACCENT: Record<QuizQuestionType, { badge: string; rail: string }> = {
  single: {
    ...
    rail: 'from-pink-400 to-pink-600',
  },
  multiple: {
...
const FOCUS = 'focus-visible:border-pink-400 focus-visible:ring-pink-400/25';
  ...
  return (
    <Reorder.Item
      ...
      className={cn(
        ...
        expanded
          ? 'border-pink-200/80 shadow-[0_12px_32px_-16px_rgba(219, 39, 119,0.35)] dark:border-pink-500/25'
    ...
    >
      ...
      <div
        className={cn(
          ...
          expanded && 'bg-gradient-to-r from-pink-50/60 to-transparent dark:from-pink-500/[0.06]',
        )}
      >
        <button
          type="button"
      ...
      {expanded && (
        ...
        >
          ...
          {!choice && (
            <>
              <div className="flex items-start gap-2.5 rounded-xl border border-pink-200/70 bg-pink-50/50 px-3 py-2.5 text-xs leading-relaxed text-pink-700 dark:border-pink-500/20 dark:bg-pink-500/[0.07] dark:text-pink-300">
