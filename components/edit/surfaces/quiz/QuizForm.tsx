...
function EmptyState() {
  ...
  return (
    <div className="mt-20 flex flex-col items-center gap-3 text-center" data-testid="quiz-empty">
      <div className="relative flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-pink-100 to-pink-50 text-pink-500 shadow-[0_8px_24px_-12px_rgba(219, 39, 119,0.5)] dark:from-pink-500/20 dark:to-pink-500/5 dark:text-pink-300">
