...
function SpeechClip({
  ...
  return (
    <div
      className={cn(
        'group/clip relative flex h-full w-[228px] shrink-0 flex-col overflow-hidden rounded-xl border border-border/85 bg-white/75 shadow-sm transition-colors focus-within:border-pink-400 hover:border-pink-300/70 dark:bg-slate-800/50 dark:hover:border-pink-500/40',
  ...
  return (
    <div
      ...
      className={cn(
        ...
        bound
          ? 'cursor-pointer hover:border-pink-300/70 dark:hover:border-pink-500/40'
    ...
    >
      {!lineMode && (
        <div
          ...
          className="group absolute inset-x-0 top-0 z-10 h-1.5 cursor-row-resize touch-none transition-colors hover:bg-pink-400/30 active:bg-pink-500/50 dark:hover:bg-pink-500/30"
        >
          <div className="absolute left-1/2 top-[3px] h-0.5 w-9 -translate-x-1/2 rounded-full bg-gray-300 transition-colors group-hover:bg-pink-400 dark:bg-gray-600 dark:group-hover:bg-pink-500" />
        </div>
      )}
