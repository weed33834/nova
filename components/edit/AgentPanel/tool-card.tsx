...
export function ScenePill({ sceneId }: { sceneId?: string }) {
  ...
  return (
    <span className="inline-flex min-w-0 max-w-[150px] shrink items-center gap-0.5 rounded-md border border-pink-200 bg-pink-50 px-1.5 py-0.5 text-[10.5px] font-medium text-[#DB2777] dark:border-pink-500/30 dark:bg-pink-500/10 dark:text-pink-300">
      <AtSign className="size-2.5 shrink-0 text-pink-500" />
...
const STATUS_TONE: Record<ToolStatus, string> = {
  running: 'text-[#DB2777] dark:text-pink-300',
  ...
  return (
    <div
      className={cn(
        ...
        running ? 'border-pink-300 dark:border-pink-500/40' : 'border-border',
      )}
    >
