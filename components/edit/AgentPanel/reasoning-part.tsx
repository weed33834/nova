    ...
    <div
      className={cn(
        ...
        interrupted
          ...
          : 'border-pink-100/70 bg-pink-50/30 dark:border-pink-500/15 dark:bg-pink-500/[0.04]',
      )}
    >
      <button
        type="button"
        ...
        className={cn(
          ...
          interrupted
            ...
            : 'text-[#DB2777]/80 hover:text-[#DB2777] dark:text-pink-300/80 dark:hover:text-pink-200',
        )}
      >
      ...
      {open ? (
        <div className="whitespace-pre-wrap break-words border-t border-pink-100/60 px-2.5 py-2 text-[12px] leading-relaxed text-muted-foreground dark:border-pink-500/10">
          {text}
        </div>
      ) : null}
    </div>
