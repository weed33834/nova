...
/**
 * Nova Agent — editor AI sidebar (right rail), "Edit with AI" Cursor-style
 * surface per the Nova AgentSidebar design board:
      ...
      <AssistantRuntimeProvider runtime={runtime}>
        ...
        <ThreadPrimitive.Root className="relative flex min-h-0 flex-1 flex-col">
            ...
            <ThreadPrimitive.Empty>
              <div className="mx-auto mt-12 flex max-w-[268px] flex-col">
                ...
                <div className="mt-5 space-y-3">
                  {capabilityKeys.map(({ label, examples }) => (
                    <div key={label} className="flex flex-col gap-0.5">
                      ...
                      <span className="text-[11.5px] leading-relaxed text-[#DB2777]/70 dark:text-pink-300/70">
                        {t(examples)}
                      </span>
                    </div>
                  ))}
                ...
                <p className="mt-2 inline-flex items-center gap-1 text-[11px] text-muted-foreground/70">
                  <Sparkles className="size-3 text-[#DB2777]/60 dark:text-pink-300/60" />
          ...
          <div className="px-3 pb-3 pt-1">
            ...
            <ComposerPrimitive.Root className="rounded-[10px] border border-border bg-card shadow-sm transition-[border-color,box-shadow] focus-within:border-pink-400 focus-within:ring-[3px] focus-within:ring-pink-500/10 dark:focus-within:ring-pink-500/20">
              {scene?.title ? (
                <div className="px-2 pt-2">
                  <span className="inline-flex max-w-full items-center gap-1 rounded-md border border-pink-200 bg-pink-50 px-2 py-0.5 text-[11px] font-medium text-[#DB2777] dark:border-pink-500/30 dark:bg-pink-500/10 dark:text-pink-300">
                    <AtSign className="size-3 shrink-0 text-pink-500" />
  ...
  if (collapsed) {
    return (
      <aside
        ...
        className="group/rail relative flex h-full w-11 shrink-0 cursor-pointer flex-col items-center gap-3 border-l border-gray-100 bg-white/80 pt-3 backdrop-blur-xl transition-colors hover:bg-pink-50/40 dark:border-gray-800 dark:bg-slate-900/80 dark:hover:bg-pink-500/5 shadow-[-2px_0_24px_rgba(0,0,0,0.02)]"
      >
        <span className="grid size-8 place-items-center rounded-lg text-[#DB2777] transition-colors group-hover/rail:bg-pink-100/70 dark:text-pink-300 dark:group-hover/rail:bg-pink-500/15">
          <PanelRightOpen className="size-4" />
        </span>
        <Sparkles className="size-4 text-[#DB2777]/80 dark:text-pink-300/80" />
        <span className="mt-1 text-[10px] font-semibold uppercase tracking-[0.16em] text-[#DB2777]/70 [writing-mode:vertical-rl] dark:text-pink-300/70">
          Edit with AI
        </span>
      </aside>
    );
  ...
  return (
    ...
    >
      <div
        ...
        className="group absolute left-0 top-0 bottom-0 z-10 w-1.5 cursor-col-resize touch-none transition-colors hover:bg-pink-400/30 active:bg-pink-500/50 dark:hover:bg-pink-500/30"
      >
        <div className="absolute left-0.5 top-1/2 h-8 w-0.5 -translate-y-1/2 rounded-full bg-gray-300 transition-colors group-hover:bg-pink-400 dark:bg-gray-600 dark:group-hover:bg-pink-500" />
      </div>
      ...
      <header className="flex h-10 shrink-0 items-center gap-2 border-b border-gray-100 px-4 pl-5 dark:border-gray-800">
        <Sparkles className="size-3.5 text-[#DB2777] dark:text-pink-300" />
        <span className="text-[13px] font-semibold text-[#DB2777] dark:text-pink-300">
          Edit with AI
        </span>
