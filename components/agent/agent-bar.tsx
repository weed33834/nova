...
export function AgentBar() {
    ...
    <div className="flex items-center gap-1.5 shrink-0">
      ...
      {agentMode === 'auto' ? (
        <>
          ...
          <Shuffle className="size-4 text-pink-400 dark:text-pink-500" />
        </>
      ) : (
        <>
  ...
  return (
    <div ref={containerRef} className="relative w-full sm:w-96" data-tour="agent-bar">
      <Tooltip>
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute right-0 top-full mt-1 z-50 w-[min(24rem,calc(100vw-2rem))] sm:w-96"
          >
              ...
              {agentMode === 'preset' ? (
                ...
                <div className="flex flex-col items-center pt-6 pb-3 gap-4">
                  <div className="relative flex items-center justify-center">
                    <div className="absolute size-10 rounded-full bg-pink-400/10 dark:bg-pink-400/15 animate-ping [animation-duration:3s]" />
                    <div className="absolute size-12 rounded-full bg-pink-400/5 dark:bg-pink-400/10 animate-pulse [animation-duration:2.5s]" />
                    <Shuffle className="relative size-5 text-pink-400 dark:text-pink-500" />
                  </div>
