...
export declare function parseVideoCodec(_arrayBuffer: ArrayBuffer): Promise<VideoCodecInfo | null>;
export declare function isVideoCodecSupported(_info: VideoCodecInfo | null): boolean;
