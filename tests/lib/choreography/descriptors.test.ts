...
describe('spotlight.v1 pins the source animation values', () => {
  it('has the dim/cutout/border layers and z-index 90 (below modal overlays)', () => {
    expect(spotlightV1.zIndex).toBe(90);
...
describe('laser.v1 pins the source animation values', () => {
  it('has the dot/ring/core layers, z-index 91 (above spotlight, below modal overlays), red default', () => {
    expect(laserV1.zIndex).toBe(91);
