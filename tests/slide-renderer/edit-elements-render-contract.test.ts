...
import type { PPTImageElement, PPTLatexElement, PPTTableElement, PPTTextElement } from '@nova/dsl';
...
import { useClipImage as usePackageClipImage } from '../../packages/@nova/renderer/src/elements/image/useClipImage';
import { imageFiltersToCss as packageImageFiltersToCss } from '../../packages/@nova/renderer/src/elements/image/useFilter';
import { BaseTextElement as PackageBaseTextElement } from '../../packages/@nova/renderer/src/elements/text/BaseTextElement';
import { StaticTable as PackageStaticTable } from '../../packages/@nova/renderer/src/elements/table/StaticTable';
