    ...
    <div className="w-60 h-40 mx-auto flex items-center justify-center">
      <div className="flex gap-3">
        {[0, 1, 2].map((i) => (
          <motion.div
            key={i}
            className="w-14 h-20 rounded-lg bg-gradient-to-br from-pink-400 to-rose-500 dark:from-pink-600 dark:to-rose-700 shadow-lg"
    ...
    switch (idx) {
      ...
      case 1:
        return {
          ...
          label: 'QUIZ',
          badge:
            'bg-rose-100 text-rose-600 border-rose-200 dark:bg-rose-900/40 dark:text-rose-300 dark:border-rose-800',
        };
      case 2:
        return {
          color: 'amber',
    ...
    <div className="size-56 relative flex items-center justify-center perspective-[800px]">
      ...
      <motion.div
        ...
        className={cn(
          ...
          theme.color === 'rose' && 'bg-rose-500/10',
      ...
      {[0, 1].map((i) => (
        <motion.div
          ...
          className={cn(
            ...
            theme.color === 'rose' && 'border-rose-500/10',
        ...
        <AnimatePresence mode="popLayout">
          <motion.div
            ...
            className={cn(
              ...
              theme.color === 'rose' && 'border-rose-200 dark:border-rose-900/30',
          ...
          >
            ...
            {index === 1 && (
              <div className="flex flex-col h-full justify-center space-y-2 pt-2">
                ...
                >
                  <div className="h-2 w-3/4 bg-rose-500/20 rounded-full" />
                </motion.div>
...
function ActionsVisualizer() {
  ...
  const actionItems = [
    {
      ...
      activeBorder: 'border-fuchsia-200 dark:border-fuchsia-800',
    },
    {
      icon: Focus,
      label: 'Spotlight',
  ...
  return (
    <div className="size-56 relative flex items-center justify-center">
      {/* Background pulse */}
      <motion.div
        className="absolute inset-0 blur-3xl rounded-full bg-fuchsia-500/8"
        animate={{ scale: [1, 1.15, 1], opacity: [0.3, 0.5, 0.3] }}
        transition={{ duration: 3.5, repeat: Infinity }}
      />
      ...
      <div className="w-44 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-xl overflow-hidden relative">
        {/* Header */}
        <div className="px-3 py-2 border-b border-slate-100 dark:border-slate-700 flex items-center gap-2">
          <Clapperboard className="size-3 text-fuchsia-500" />
          <motion.div
            initial={{ width: 0 }}
            animate={{ width: '50%' }}
            transition={{ delay: 0.2 }}
            className="h-1.5 bg-fuchsia-500/20 rounded-full"
          />
        </div>
        ...
        <div className="p-2 space-y-1.5 relative">
          ...
          <motion.div
            className="absolute left-2 right-2 rounded-lg bg-fuchsia-500/[0.06] dark:bg-fuchsia-400/[0.08]"
            style={{ height: ROW_H - 6 }}
