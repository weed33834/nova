 ...
 *
 * The app loads the parser at runtime from `/vendor/importer/index.js` — a
 * gitignored build artifact that `scripts/sync-importer.mjs` copies into
...
const entry = path.join(root, 'public/vendor/importer/index.js');
